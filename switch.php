              ...
              <div class="header-button">
                  ...
                  <div class="noti__item js-item-menu">
                    ...
                    <div class="email-dropdown js-dropdown">
                      ...
                      <div class="email__item">
                        ...
                        <div class="content">
                          <p>Meeting about new dashboard...</p>
                          <span>Đại học Sư Phạm Kỹ Thuật, May 12,2021</span>
                        </div>
                      </div>
                ...
                <div class="account-wrap">
                  <div class="account-item clearfix js-item-menu">
                    ...
                    <div class="content">
                      <a class="js-acc-btn" href="https://www.facebook.com/nguyendongbang1999/">Bang Nguyen</a>
                    </div>
                    <div class="account-dropdown js-dropdown">
                      <div class="info clearfix">
                        ...
                        <div class="content">
                          <h5 class="name">
                            <a href="https://www.facebook.com/nguyendongbang1999/">Bang Nguyen</a>
                          </h5>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-header">
                    <strong class="card-title">Auto</strong>
                  </div>
                  <div class="card-body">
                    <div class="col-md-6">
                      <p>Bơm (giây)</p>
                      <input class="au-input au-input--full" type="Timer" name="Timer" placeholder="Timer">
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-header">
                    <strong class="card-title">Manual</strong>
                  </div>
                  <div class="card-body">
                    <div class="col-md-6">
                      <p>Bơm</p>
